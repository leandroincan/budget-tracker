    ...
    if not df.empty:
        ...
        if not df.empty:
            ...
            table_html = (
                ...
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Date</th>'
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Description</th>'
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Amount</th>'
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Category</th>'
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Who</th>'
                '<th style="text-align:left; padding:8px 12px; font-weight:normal; color:#333;">Receipt</th>'
                '</tr></thead>'
